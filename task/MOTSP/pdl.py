"""
Preference Distribution Learning (PDL) for the Multi-Objective Traveling Salesman Problem (MOTSP).
"""
...
# Path to the pre-generated MOTSP test set (provided by PMOCO).
TEST_DATA_PATH = './motsp100_test_seed1234.pkl'
