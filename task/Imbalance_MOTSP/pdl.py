"""
Preference Distribution Learning (PDL) for the Asymmetric Multi-Objective Traveling Salesman Problem (A-MOTSP).
"""
...
# Path to the pre-generated A-MOTSP test set (provided by PMOCO).
TEST_DATA_PATH = './Imbalance_motsp20_test_seed1234.pkl'
...
def eval_generator():
    ...
    # Optional correction factor for endpoint preferences (Section IV-B).
